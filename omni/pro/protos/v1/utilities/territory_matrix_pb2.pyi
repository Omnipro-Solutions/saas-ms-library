...
class TerritoryMatrix(_message.Message):
    __slots__ = ["active", "code", "id", "name", "object_audit", "sequence"]
    ...
    sequence: int
    def __init__(self, id: _Optional[str] = ..., sequence: _Optional[int] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., active: bool = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class TerritoryMatrixAddRequest(_message.Message):
    ...
    name: str
    sequence: int
    def __init__(self, country_id: _Optional[str] = ..., sequence: _Optional[int] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., active: bool = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...

class TerritoryMatrixAddResponse(_message.Message):
    __slots__ = ["response_standard", "territory_matrix"]
    RESPONSE_STANDARD_FIELD_NUMBER: _ClassVar[int]
    TERRITORY_MATRIX_FIELD_NUMBER: _ClassVar[int]
    response_standard: _base_pb2.ResponseStandard
    territory_matrix: TerritoryMatrix
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., territory_matrix: _Optional[_Union[TerritoryMatrix, _Mapping]] = ...) -> None: ...

class TerritoryMatrixDeleteRequest(_message.Message):
    __slots__ = ["context", "country_id", "id"]
    CONTEXT_FIELD_NUMBER: _ClassVar[int]
    COUNTRY_ID_FIELD_NUMBER: _ClassVar[int]
    ID_FIELD_NUMBER: _ClassVar[int]
    context: _base_pb2.Context
    country_id: str
    id: str
    def __init__(self, country_id: _Optional[str] = ..., id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
