...
class DeliveryMethodWarehouseHierarchy(_message.Message):
    __slots__ = ["active", "delivery_method_warehouse_id", "id", "object_audit", "warehouse_hierarchy_id"]
    ...
    def __init__(self, id: _Optional[int] = ..., delivery_method_warehouse_id: _Optional[int] = ..., warehouse_hierarchy_id: _Optional[int] = ..., active: bool = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...

class DeliveryMethodWarehouseHierarchyCreateRequest(_message.Message):
    __slots__ = ["context", "delivery_method_warehouse_id", "warehouse_hierarchy_id"]
    ...
    delivery_method_warehouse_id: int
    warehouse_hierarchy_id: int
    def __init__(self, delivery_method_warehouse_id: _Optional[int] = ..., warehouse_hierarchy_id: _Optional[int] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class DeliveryMethodWarehouseHierarchyCreateResponse(_message.Message):
    ...
    def __init__(self, delivery_method_warehouse_hierarchy: _Optional[_Union[DeliveryMethodWarehouseHierarchy, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class DeliveryMethodWarehouseHierarchyReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, delivery_method_warehouse_hierarchys: _Optional[_Iterable[_Union[DeliveryMethodWarehouseHierarchy, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...

class DeliveryMethodWarehouseHierarchyUpdateRequest(_message.Message):
    __slots__ = ["context", "delivery_method_warehouse_hierarchy"]
    CONTEXT_FIELD_NUMBER: _ClassVar[int]
    DELIVERY_METHOD_WAREHOUSE_HIERARCHY_FIELD_NUMBER: _ClassVar[int]
    context: _base_pb2.Context
    delivery_method_warehouse_hierarchy: DeliveryMethodWarehouseHierarchy
    def __init__(self, delivery_method_warehouse_hierarchy: _Optional[_Union[DeliveryMethodWarehouseHierarchy, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
