...
from v1.rules import schedule_work_pb2 as v1_dot_rules_dot_schedule__work__pb2
...
class ScheduleWorkService(object):
    ...
    @staticmethod
    def ScheduleWorkCreate(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.schedule_work.ScheduleWorkService/ScheduleWorkCreate',
    ...
    def ScheduleWorkRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.schedule_work.ScheduleWorkService/ScheduleWorkRead',
    ...
    @staticmethod
    def ScheduleWorkUpdate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.schedule_work.ScheduleWorkService/ScheduleWorkUpdate',
    ...
    @staticmethod
    def ScheduleWorkDelete(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.schedule_work.ScheduleWorkService/ScheduleWorkDelete',
