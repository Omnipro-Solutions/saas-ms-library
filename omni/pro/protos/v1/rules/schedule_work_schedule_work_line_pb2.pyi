...
class ScheduleRefCreateRequest(_message.Message):
...
class ScheduleRefCreateResponse(_message.Message):
    ...
    schedule_work_schedule_work_line: ScheduleRef
    def __init__(
        self,
        schedule_work_schedule_work_line: _Optional[_Union[ScheduleRef, _Mapping]] = ...,
        response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...,
    ) -> None: ...

class ScheduleRefDeleteRequest(_message.Message):
...
class ScheduleRefDeleteResponse(_message.Message):
    __slots__ = ["response_standard"]
    RESPONSE_STANDARD_FIELD_NUMBER: _ClassVar[int]
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...

class ScheduleRefReadRequest(_message.Message):
...
class ScheduleRefReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    schedule_work_schedule_work_line: _containers.RepeatedCompositeFieldContainer[ScheduleRef]
    def __init__(
        self,
        schedule_work_schedule_work_line: _Optional[_Iterable[_Union[ScheduleRef, _Mapping]]] = ...,
        meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ...,
        response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...,
    ) -> None: ...

class ScheduleRefUpdateRequest(_message.Message):
...
class ScheduleRefUpdateResponse(_message.Message):
    __slots__ = ["response_standard", "schedule_work_schedule_work_line"]
    RESPONSE_STANDARD_FIELD_NUMBER: _ClassVar[int]
    SCHEDULE_WORK_SCHEDULE_WORK_LINE_FIELD_NUMBER: _ClassVar[int]
    response_standard: _base_pb2.ResponseStandard
