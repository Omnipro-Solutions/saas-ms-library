...
class DeliveryMethod(_message.Message):
    ...
    def __init__(
        ...
        quantity_sequrity: _Optional[float] = ...,
        code: _Optional[str] = ...,
        type_delivery: _Optional[_Union[TypeDelivery, str]] = ...,
        delivery_location_id: _Optional[int] = ...,
        transfer_template_id: _Optional[int] = ...,
        category_template_id: _Optional[int] = ...,
        local_available_id: _Optional[int] = ...,
        schedule_template_id: _Optional[int] = ...,
        active: bool = ...,
