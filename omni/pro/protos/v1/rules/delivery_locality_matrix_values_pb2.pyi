...
class DeliveryLocalityMatrixValues(_message.Message):
    ...
    def __init__(self, id: _Optional[int] = ..., delivery_locality_id: _Optional[int] = ..., territory_matrix_values_id: _Optional[int] = ..., active: bool = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class DeliveryLocalityMatrixValuesCreateRequest(_message.Message):
    ...
    delivery_locality_id: int
    territory_matrix_values_id: int
    def __init__(self, delivery_locality_id: _Optional[int] = ..., territory_matrix_values_id: _Optional[int] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class DeliveryLocalityMatrixValuesCreateResponse(_message.Message):
    ...
    def __init__(self, delivery_locality_matrix_values: _Optional[_Union[DeliveryLocalityMatrixValues, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class DeliveryLocalityMatrixValuesReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, delivery_locality_matrix_valuess: _Optional[_Iterable[_Union[DeliveryLocalityMatrixValues, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class DeliveryLocalityMatrixValuesUpdateRequest(_message.Message):
    ...
    context: _base_pb2.Context
    delivery_locality_matrix_values: DeliveryLocalityMatrixValues
    def __init__(self, delivery_locality_matrix_values: _Optional[_Union[DeliveryLocalityMatrixValues, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
