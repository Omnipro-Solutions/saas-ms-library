...
class DeliveryCategoryCategory(_message.Message):
    ...
    def __init__(self, id: _Optional[int] = ..., delivery_category_id: _Optional[int] = ..., category_id: _Optional[int] = ..., active: bool = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class DeliveryCategoryCategoryCreateRequest(_message.Message):
    ...
    delivery_category_id: int
    def __init__(self, delivery_category_id: _Optional[int] = ..., category_id: _Optional[int] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class DeliveryCategoryCategoryCreateResponse(_message.Message):
    ...
    def __init__(self, delivery_category_category: _Optional[_Union[DeliveryCategoryCategory, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class DeliveryCategoryCategoryReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, delivery_category_categories: _Optional[_Iterable[_Union[DeliveryCategoryCategory, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class DeliveryCategoryCategoryUpdateRequest(_message.Message):
    ...
    context: _base_pb2.Context
    delivery_category_category: DeliveryCategoryCategory
    def __init__(self, delivery_category_category: _Optional[_Union[DeliveryCategoryCategory, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
