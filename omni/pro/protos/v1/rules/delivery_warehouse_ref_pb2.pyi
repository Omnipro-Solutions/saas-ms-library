...
class DeliveryWarehouseRefCreateResponse(_message.Message):
    __slots__ = ["delviery_method_warehouse", "response_standard"]
    DELVIERY_METHOD_WAREHOUSE_FIELD_NUMBER: _ClassVar[int]
    RESPONSE_STANDARD_FIELD_NUMBER: _ClassVar[int]
    delviery_method_warehouse: DeliveryWarehouseRef
    response_standard: _base_pb2.ResponseStandard
    def __init__(
        self,
        delviery_method_warehouse: _Optional[_Union[DeliveryWarehouseRef, _Mapping]] = ...,
...
class DeliveryWarehouseRefReadResponse(_message.Message):
    __slots__ = ["delviery_method_warehouse", "meta_data", "response_standard"]
    DELVIERY_METHOD_WAREHOUSE_FIELD_NUMBER: _ClassVar[int]
    META_DATA_FIELD_NUMBER: _ClassVar[int]
    RESPONSE_STANDARD_FIELD_NUMBER: _ClassVar[int]
    delviery_method_warehouse: _containers.RepeatedCompositeFieldContainer[DeliveryWarehouseRef]
    meta_data: _base_pb2.MetaData
    response_standard: _base_pb2.ResponseStandard
    def __init__(
        self,
        delviery_method_warehouse: _Optional[_Iterable[_Union[DeliveryWarehouseRef, _Mapping]]] = ...,
        meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ...,
        response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...,
    ) -> None: ...

class DeliveryWarehouseRefUpdateRequest(_message.Message):
    __slots__ = ["context", "delviery_method_warehouse"]
    CONTEXT_FIELD_NUMBER: _ClassVar[int]
    DELVIERY_METHOD_WAREHOUSE_FIELD_NUMBER: _ClassVar[int]
    context: _base_pb2.Context
    delviery_method_warehouse: DeliveryWarehouseRef
