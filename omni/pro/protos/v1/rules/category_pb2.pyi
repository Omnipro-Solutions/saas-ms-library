...
class Category(_message.Message):
    __slots__ = ["active", "category_doc_id", "code", "id", "name", "object_audit"]
    ...
    def __init__(self, id: _Optional[int] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., category_doc_id: _Optional[str] = ..., active: bool = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...

class CategoryCreateRequest(_message.Message):
    __slots__ = ["category_doc_id", "code", "context", "name"]
    CATEGORY_DOC_ID_FIELD_NUMBER: _ClassVar[int]
    CODE_FIELD_NUMBER: _ClassVar[int]
    ...
    name: str
    def __init__(self, name: _Optional[str] = ..., code: _Optional[str] = ..., category_doc_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class CategoryCreateResponse(_message.Message):
    ...
    def __init__(self, category: _Optional[_Union[Category, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class CategoryReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, categories: _Optional[_Iterable[_Union[Category, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class CategoryUpdateRequest(_message.Message):
    ...
    category: Category
    context: _base_pb2.Context
    def __init__(self, category: _Optional[_Union[Category, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
