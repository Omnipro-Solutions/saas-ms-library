...
class Attachment(_message.Message):
    ...
    type: str
    def __init__(self, id: _Optional[int] = ..., doc_id: _Optional[str] = ..., name: _Optional[str] = ..., type: _Optional[str] = ..., active: bool = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class AttachmentCreateRequest(_message.Message):
    ...
    name: str
    type: str
    def __init__(self, doc_id: _Optional[str] = ..., name: _Optional[str] = ..., type: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class AttachmentCreateResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., attachment: _Optional[_Union[Attachment, _Mapping]] = ...) -> None: ...
...
class AttachmentReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., attachments: _Optional[_Iterable[_Union[Attachment, _Mapping]]] = ...) -> None: ...
...
class AttachmentUpdateRequest(_message.Message):
    ...
    attachment: Attachment
    context: _base_pb2.Context
    def __init__(self, attachment: _Optional[_Union[Attachment, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class Carrier(_message.Message):
    ...
    name: str
    object_audit: _base_pb2.ObjectAudit
    def __init__(self, id: _Optional[int] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., active: bool = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class CarrierCreateRequest(_message.Message):
    ...
    context: _base_pb2.Context
    name: str
    def __init__(self, name: _Optional[str] = ..., code: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class CarrierCreateResponse(_message.Message):
    ...
    carrier: Carrier
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., carrier: _Optional[_Union[Carrier, _Mapping]] = ...) -> None: ...
...
class CarrierReadResponse(_message.Message):
    ...
    meta_data: _base_pb2.MetaData
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., carriers: _Optional[_Iterable[_Union[Carrier, _Mapping]]] = ...) -> None: ...
...
class CarrierUpdateRequest(_message.Message):
    ...
    carrier: Carrier
    context: _base_pb2.Context
    def __init__(self, carrier: _Optional[_Union[Carrier, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class Picking(_message.Message):
    __slots__ = ["active", "attachment_guide_id", "attachment_invoice_id", "carrier_id", "carrier_tracking_ref", "date_delivery", "date_done", "group_id", "id", "location_dest_id", "location_id", "name", "object_audit", "origin", "picking_type_id", "scheduled_date", "shipping_weight", "time_assigned", "time_total_preparation", "user_id", "weight"]
    ACTIVE_FIELD_NUMBER: _ClassVar[int]
    ...
    user_id: int
    weight: float
    def __init__(self, id: _Optional[int] = ..., name: _Optional[str] = ..., picking_type_id: _Optional[int] = ..., location_id: _Optional[int] = ..., location_dest_id: _Optional[int] = ..., user_id: _Optional[int] = ..., attachment_guide_id: _Optional[int] = ..., attachment_invoice_id: _Optional[int] = ..., origin: _Optional[str] = ..., date_done: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., scheduled_date: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., time_total_preparation: _Optional[float] = ..., time_assigned: _Optional[float] = ..., carrier_id: _Optional[int] = ..., date_delivery: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., carrier_tracking_ref: _Optional[str] = ..., group_id: _Optional[int] = ..., weight: _Optional[float] = ..., shipping_weight: _Optional[float] = ..., active: bool = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...

class PickingCreateRequest(_message.Message):
    __slots__ = ["attachment_guide_id", "attachment_invoice_id", "carrier_id", "carrier_tracking_ref", "context", "date_delivery", "date_done", "group_id", "location_dest_id", "location_id", "name", "origin", "picking_type_id", "scheduled_date", "shipping_weight", "time_assigned", "time_total_preparation", "user_id", "weight"]
    ATTACHMENT_GUIDE_ID_FIELD_NUMBER: _ClassVar[int]
    ATTACHMENT_INVOICE_ID_FIELD_NUMBER: _ClassVar[int]
    CARRIER_ID_FIELD_NUMBER: _ClassVar[int]
    CARRIER_TRACKING_REF_FIELD_NUMBER: _ClassVar[int]
    ...
    user_id: int
    weight: float
    def __init__(self, name: _Optional[str] = ..., picking_type_id: _Optional[int] = ..., location_id: _Optional[int] = ..., location_dest_id: _Optional[int] = ..., user_id: _Optional[int] = ..., attachment_guide_id: _Optional[int] = ..., attachment_invoice_id: _Optional[int] = ..., origin: _Optional[str] = ..., date_done: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., scheduled_date: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., time_total_preparation: _Optional[float] = ..., time_assigned: _Optional[float] = ..., carrier_id: _Optional[int] = ..., date_delivery: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., carrier_tracking_ref: _Optional[str] = ..., group_id: _Optional[int] = ..., weight: _Optional[float] = ..., shipping_weight: _Optional[float] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class PickingCreateResponse(_message.Message):
    ...
    picking: Picking
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., picking: _Optional[_Union[Picking, _Mapping]] = ...) -> None: ...
...
class PickingReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., pickings: _Optional[_Iterable[_Union[Picking, _Mapping]]] = ...) -> None: ...
...
class PickingUpdateRequest(_message.Message):
    ...
    context: _base_pb2.Context
    picking: Picking
    def __init__(self, picking: _Optional[_Union[Picking, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class ProcurementGroup(_message.Message):
    ...
    name: str
    object_audit: _base_pb2.ObjectAudit
    def __init__(self, id: _Optional[int] = ..., name: _Optional[str] = ..., move_type: _Optional[str] = ..., active: bool = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class ProcurementGroupCreateRequest(_message.Message):
    ...
    move_type: str
    name: str
    def __init__(self, name: _Optional[str] = ..., move_type: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class ProcurementGroupCreateResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., procurement_group: _Optional[_Union[ProcurementGroup, _Mapping]] = ...) -> None: ...
...
class ProcurementGroupReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., procurement_groups: _Optional[_Iterable[_Union[ProcurementGroup, _Mapping]]] = ...) -> None: ...
...
class ProcurementGroupUpdateRequest(_message.Message):
    ...
    context: _base_pb2.Context
    procurement_group: ProcurementGroup
    def __init__(self, procurement_group: _Optional[_Union[ProcurementGroup, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class User(_message.Message):
    ...
    object_audit: _base_pb2.ObjectAudit
    user_doc_id: str
    def __init__(self, id: _Optional[int] = ..., user_doc_id: _Optional[str] = ..., name: _Optional[str] = ..., active: bool = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class UserCreateRequest(_message.Message):
    ...
    name: str
    user_doc_id: str
    def __init__(self, user_doc_id: _Optional[str] = ..., name: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
